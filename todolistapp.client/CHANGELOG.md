...
- Creare un progetto react con create-vite: `npm init --yes vite@latest todolistapp.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Creare il file di progetto (`todolistapp.client.esproj`).
